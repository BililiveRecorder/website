---
title: 文件名模板
description: 录播姬输出的录播文件名的模板说明
---
import { Card } from '@astrojs/starlight/components';

录播姬的文件名模板使用了 [Liquid](https://shopify.github.io/liquid/basics/introduction/) ([第三方中文镜像](https://liquid.bootcss.com/basics/introduction/)) 语法，如果你用过下面这些工具的话这个语法应该会很熟悉。
...
基础的语法请参考 [Liquid 原版文档](https://shopify.github.io/liquid/basics/introduction/) 或 [第三方翻译的中文镜像](https://liquid.bootcss.com/basics/introduction/)，这里就不再复制粘贴过来一份了。
...
<details>
<summary>JSON 数据参考 (点击展开示例)</summary>
...
用 .NET 的 [日期格式字符串](https://docs.microsoft.com/zh-cn/dotnet/standard/base-types/custom-date-and-time-format-strings) 格式化日期。
...
<details>
<summary>日期格式化字符表 (点击展开)</summary>

本段内容是从[微软官方文档](https://docs.microsoft.com/zh-cn/dotnet/standard/base-types/custom-date-and-time-format-strings)复制的, licensed under CC-BY.
...
文档：[标准数字格式字符串](https://docs.microsoft.com/zh-cn/dotnet/standard/base-types/standard-numeric-format-strings)、[自定义数字格式字符串](https://docs.microsoft.com/zh-cn/dotnet/standard/base-types/custom-numeric-format-strings)。
...
[微软文档](https://docs.microsoft.com/zh-cn/dotnet/api/system.string.format#Starting)
